      ...
      <Slider {...settings}>
        <div className='card' style={{ position: "relative" }}>
          ...
          <div class='black'>
            ...
            <div class="watch">
              <i><a href="https://youtu.be/JM1U-Whb-P0?si=uqpeQO8c7pWTRGPG"><FiVideo /></a></i>
        ...
        <div className='card'>
          ...
          <div class='black'>
            ...
            <div class="watch">
              <i><a href='https://www.youtube.com/results?search_query=icc+world+cup+2023+live'><FiVideo/></a></i>
              <p style={{ color: "black" }}>watch the gameplay</p>
            </div>
          </div>
        </div>
        <div className='card'>
